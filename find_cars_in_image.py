...
def find_cars_in_image(image, prev_hot_windows=None):
    ...
    if find_cars_in_image_windows is None:
        ...
        y_start_stop_96 = [int(0.525 * image_height), int(0.75 * image_height)]
        y_start_stop_128 = [int(0.525 * image_height), int(0.8 * image_height)]
        y_start_stop_160 = [int(0.525 * image_height), int(0.85 * image_height)]
        y_start_stop_192 = [int(0.525 * image_height), int(0.9 * image_height)]
        y_start_stop_224 = [int(0.525 * image_height), int(0.95 * image_height)]
        y_start_stop_256 = [int(0.525 * image_height), None]
